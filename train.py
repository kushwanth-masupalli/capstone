...
GAN synthetic augmentation (see GAN_AUGMENTATION.md):
    python train.py --backbone xrv --epochs 80 --balanced_sampling --focal_loss \
        --save_prefix gan_ --synthetic_dir data/synthetic
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--synthetic_dir", type=str, default=None,
                        help="Path to GAN-generated synthetic images (e.g. data/synthetic). "
                             "Images are added to the TRAIN split only; val/test stay real-only.")
